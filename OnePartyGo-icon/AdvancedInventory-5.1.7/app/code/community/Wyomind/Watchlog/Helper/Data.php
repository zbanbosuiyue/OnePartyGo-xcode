    ...
    public function checkNotification() {
        ...
        $percent = Mage::getModel("watchlog/watchlog")->getFailedPercentFromDate($last_notification)->getPercent();
         ...
         if ($percent > $failed_limit) {
            ...
            $notification_link = Mage::helper("adminhtml")->getUrl("adminhtml/notification/index");
            $watchlog_link = Mage::helper("adminhtml")->getUrl("adminhtml/basic/index");
            ...
            if (isset($data["notification_id"])) {
                ...
                $notify->setDescription($this->__($notification_description, round($percent * 100), $watchlog_link));
