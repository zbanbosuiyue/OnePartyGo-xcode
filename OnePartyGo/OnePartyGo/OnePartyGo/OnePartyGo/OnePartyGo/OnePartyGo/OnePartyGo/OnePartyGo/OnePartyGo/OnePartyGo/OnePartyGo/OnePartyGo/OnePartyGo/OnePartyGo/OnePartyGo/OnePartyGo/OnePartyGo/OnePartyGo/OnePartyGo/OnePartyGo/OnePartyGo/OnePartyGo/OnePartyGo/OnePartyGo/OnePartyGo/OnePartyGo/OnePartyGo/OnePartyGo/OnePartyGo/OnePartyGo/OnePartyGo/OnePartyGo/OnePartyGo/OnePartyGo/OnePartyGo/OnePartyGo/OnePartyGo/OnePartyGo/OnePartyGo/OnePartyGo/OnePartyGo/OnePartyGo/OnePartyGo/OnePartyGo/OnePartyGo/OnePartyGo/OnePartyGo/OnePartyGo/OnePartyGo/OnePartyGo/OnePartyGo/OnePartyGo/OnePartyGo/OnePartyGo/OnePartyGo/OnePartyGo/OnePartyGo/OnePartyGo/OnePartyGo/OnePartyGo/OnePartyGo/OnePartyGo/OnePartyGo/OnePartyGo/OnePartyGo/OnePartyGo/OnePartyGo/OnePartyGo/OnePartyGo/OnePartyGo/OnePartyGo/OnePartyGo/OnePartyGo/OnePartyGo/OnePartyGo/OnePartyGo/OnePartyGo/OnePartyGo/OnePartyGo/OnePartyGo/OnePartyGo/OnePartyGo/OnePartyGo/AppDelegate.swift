...
class AppDelegate: UIResponder, UIApplicationDelegate, WXApiDelegate {
    ...
    func showLeadPage()-> UIViewController{
        if let _ = localStorage.objectForKey(localStorageKeys.UserEmail), let _ = localStorage.objectForKey(localStorageKeys.UserPhone), let _ = localStorage.objectForKey(localStorageKeys.UserPwd)  {
    ...
    func onResp(resp: BaseResp!) {
        if resp.isKindOfClass(SendAuthResp) {
            ...
            if response.code != nil{
                ...
                print(response.code)
                window?.rootViewController?.getWeChatUserInfo(response.code)
