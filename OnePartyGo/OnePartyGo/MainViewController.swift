...
class MainViewController: MainBasicViewController{
    ...
    func checkAccessToken(){
        ...
        if let phone_access_token = localStorage.objectForKey(localStorageKeys.PhoneAccessToken), phone_number = localStorage.objectForKey(localStorageKeys.UserPhone){
